    ...
    if ($is_reserva) {
        ...
        if ($id) {
            ...
            $query = "UPDATE reservas SET 
                      docente_id = " . $docentes_to_check[0] . ",
                      curso_id = $curso_id,
            ...
            $query = "INSERT INTO reservas (docente_id, curso_id, ambiente_id, usuario_id, data_inicio, data_fim, dias_semana, hora_inicio, hora_fim, sigla, periodo, status, vagas, local, tipo, tipo_custeio, valor_turma, numero_proposta) 
                      VALUES (" . $docentes_to_check[0] . ", $curso_id, $ambiente_id, $usuario_id, '$data_inicio', '$data_fim', '$dias_semana_str', '$horario_inicio', '$horario_fim', '$sigla', '$periodo', '$status_inicial', $vagas, '$local', '$tipo', '$tipo_custeio', $valor_turma, '$numero_proposta')";
        }
