...
foreach ($docentes as $d) {
    ...
    $gantt_docentes[] = [
        ...
        'events' => $docente_events // Agora enviamos o objeto de eventos expandidos
    ];
}
...
$gantt_data = [
    'year' => date('Y', strtotime($mes_sel)),
    'month' => date('m', strtotime($mes_sel)),
...
<div class="dashboard-vendas-hero">
    ...
    <div class="vendas-search-wrapper">
        <div class="vendas-search-box">
            ...
            <input type="text" id="gantt-search-docente" placeholder="Pesquisar Docente por Nome ou Área..." oninput="filterGanttDocentes()">
        </div>
    </div>
</div>
...
<div class="gantt-controls-container">
    <div class="month-selector-vendas">
        <button type="button" onclick="navigateVendasMonth(-1)" class="btn-nav"><i class="fas fa-chevron-left"></i></button>
        <span id="vendas-month-label"><?= $mes_label ?></span>
        <button type="button" onclick="navigateVendasMonth(1)" class="btn-nav"><i class="fas fa-chevron-right"></i></button>
