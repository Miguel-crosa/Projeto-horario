                ...
                <div class="dash-section-body" style="padding: 0;">
                    ...
                    <?php else: ?>
                        <?php foreach ($encerradas as $te): ?>
                            <div class="proximas-item" <?= !isCRI() ? "onclick=\"location.href='php/views/turmas.php?id={$te['id']}'\"" : '' ?>
                                style="padding: 12px 15px; border-bottom: 1px solid var(--border-color);
                    ...
                    <?php else: ?>
                        <div class="proximas-list">
                            <?php foreach ($proximas as $pt): ?>
                                <div class="proximas-item" <?= !isCRI() ? "onclick=\"location.href='php/views/turmas.php?id={$pt['id']}'\"" : '' ?>
                            ...
                            flex; flex-direction: column; gap: 6px;">
                                    <div style="display: flex; justify-content: space-between; align-items: flex-start;">
                                        <span
                                            style="font-weight: 800; font-size: 0.9rem; color: #ff8f00; letter-spacing: 0.5px;">
